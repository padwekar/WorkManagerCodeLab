...
class BlurActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.workManager.getWorkInfosForUniqueWorkLiveData(IMAGE_MANIPULATION_WORK_NAME).observe(this, Observer {
                    ...
                    if(workInfo.state == WorkInfo.State.SUCCEEDED){
                        ...
                        val outputUri = workInfo.outputData.getString("input_uri")
